...
type DbTrieNode struct {
	...
	ChildHashes   map[uint32][]byte      `protobuf:"bytes,4,rep,name=childHashes,proto3" json:"childHashes,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *DbTrieNode) GetChildHashes() map[uint32][]byte {
	if x != nil {
...
var file_sync_trie_proto_rawDesc = string([]byte{
	...
	,
...
var (
	...
	file_sync_trie_proto_rawDescData []byte
)

func file_sync_trie_proto_rawDescGZIP() []byte {
	file_sync_trie_proto_rawDescOnce.Do(func() {
		file_sync_trie_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sync_trie_proto_rawDesc), len(file_sync_trie_proto_rawDesc)))
	})
