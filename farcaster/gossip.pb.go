...
func (x *NetworkLatencyMessage) GetBody() isNetworkLatencyMessage_Body {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *NetworkLatencyMessage) GetPingMessage() *PingMessageBody {
	if x != nil {
		if x, ok := x.Body.(*NetworkLatencyMessage_PingMessage); ok {
...
func (x *NetworkLatencyMessage) GetAckMessage() *AckMessageBody {
	if x != nil {
		if x, ok := x.Body.(*NetworkLatencyMessage_AckMessage); ok {
			return x.AckMessage
		}
	}
	return nil
...
func (x *GossipMessage) GetMessage() *Message {
	if x != nil {
		if x, ok := x.Content.(*GossipMessage_Message); ok {
			return x.Message
		}
	}
	return nil
...
func (x *GossipMessage) GetContactInfoContent() *ContactInfoContent {
	if x != nil {
		if x, ok := x.Content.(*GossipMessage_ContactInfoContent); ok {
...
func (x *GossipMessage) GetNetworkLatencyMessage() *NetworkLatencyMessage {
	if x != nil {
		if x, ok := x.Content.(*GossipMessage_NetworkLatencyMessage); ok {
...
func (x *GossipMessage) GetMessageBundle() *MessageBundle {
	if x != nil {
		if x, ok := x.Content.(*GossipMessage_MessageBundle); ok {
